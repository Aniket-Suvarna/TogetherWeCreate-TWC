...
if ($mydb->connect_error) {
    ...
    $sql = "SELECT `Date`, `Eventname`, `short`, `Filenames`, `Height`, `Width` FROM `events`";
    ...
    <nav class="navbar navbar-expand-sm navbar-dark bg-dark" style="border-bottom: 4px; border-color: rgb(255, 123, 46); border-style: none none solid none;">
        <div class="container-fluid ">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="navbar-brand active"><a href="../Sign_in/Donate_login.php"><i class="donate links">Donate</i></a></li>
            </ul>
            <ul class="nav navbar-nav navbar-right">
            ...
            <div class="card">
                <div class="card-header" id="headingTwo<?php print($a); ?>">
                    <h5 class="mb-0">
                        <button style="font-size:x-large; border-radius:5px" class="btn btn-link collapsed nav-link bloglink" data-toggle="collapse" data-target="#collapseTwo<?php print($a); ?>" aria-expanded="false" aria-controls="collapseTwo">
                            <i class="bi bi-stars"></i> <?php echo $rows['Eventname']; ?>
                        </button>

                    </h5>
                    <h4 style="float: right;"><i class="bi bi-calendar3" style="color: #FF7B2E; padding-right:12px; font-size:xxs-large;"></i><?php echo $rows['Date']; ?></h4>
                </div>
                <div id="collapseTwo<?php print($a); ?>" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion<?php print($a); ?>">
                    ...
                    <div style="font-size:xx-large; border-radius:5px; text-align:center; color:#FF7B2E;">
                        <i class="bi bi-chevron-double-left"></i><b><?php echo $rows['Eventname']; ?></b><i class="bi bi-chevron-double-right"></i>
                    </div>
                    <br>
                    <br>
                    <div style="text-align:center;">

                        <img src="../EventsImages/<?php echo $rows['Filenames']; ?>" width="<?php echo $rows['Width']; ?>" height="<?php echo $rows['Height']; ?>" style="border-radius: 40px;">
                    </div>
                    <br>
                    <br>
                    <div class="card-body">
                        <b style="color: #FF7B2E; font-size:xx-large">O</b><b style="font-size: x-large;">n</b>&nbsp;&nbsp;&nbsp;<b style="font-size: x-large;"><?php echo $rows['Date']; ?>&nbsp;:</b><br><br>

                        <div style="font-size:large ;"><?php echo $rows['short']; ?></div>
                    </div>
                </div>
            </div>
